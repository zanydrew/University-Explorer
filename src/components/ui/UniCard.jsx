    ...
    return (
        <div className="sc-card">
            <div className="sc-banner">
                <img src={data.image} alt={data.name} className="sc-banner-img" />
                <div className="sc-banner-bottom">
                    <div className="sc-logo-wrap">
                        <img src={data.logo} alt={data.name} />
                    </div>
                    <span className="sc-banner-title">{data.name}</span>
                </div>
            </div>
            ...
            <div className="sc-content">
                ...
                <div className="sc-stats-grid">
                    <div className="sc-stat">
                        ...
                        <div><div className="sc-stat-label">Location</div><div className="sc-stat-value">{data.location}</div></div>
                    </div>
                    <div className="sc-stat">
                    ...
                    <div className="sc-stat">
                        ...
                        <div><div className="sc-stat-label">Programs</div><div className="sc-stat-value">{data.programsCount} programs</div></div>
                    </div>
                    <div className="sc-stat">
                        <div className="sc-stat-icon"><Clock size={13} /></div>
                        <div><div className="sc-stat-label">Admission Date</div><div className="sc-stat-value">{data.admissionDate}</div></div>
                    </div>
                </div>
